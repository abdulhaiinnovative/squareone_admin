...
import 'package:squareone_admin/ui/component/marketing_tile.dart';
import 'package:squareone_admin/ui/views/tickets/marketing/marketing_tickets.dart';
                      ...
                      child: GridView.builder(
                          ...
                          gridDelegate:
                              const SliverGridDelegateWithFixedCrossAxisCount(
                                  ...
                                  crossAxisSpacing: 10,
                                  crossAxisCount: 2),
                          itemCount: marketingCardTitle.length,
                          itemBuilder: (context, index) {
                            return GestureDetector(
                              ...
                              child: MarketingTile(
                                width: width,
                                height: height,
                                title: marketingCardTitle[index],
                                imgUrl: marketingCardImages[index],
                                header: marketingCardHeaders[index],
                              ),
                            );
                          }))
                ],
