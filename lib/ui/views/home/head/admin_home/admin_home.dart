...
class _AdminHomeState extends State<AdminHome> {
  ...
  Widget build(BuildContext context) {
    ...
    final cardController = CardsController();
                              ...
                              children: [
                                Padding(
                                  ...
                                  child: Material(
                                    ...
                                    child: Obx(
                                      () => Text(
                                        'Hi ${controller.adminName.value}! Welcome to Square1',
                    ...
                    ListView(
                      ...
                      children: [
                              ...
                              GridView.count(
                                ...
                                children: [
                                  ...
                                  MetricCard(
                                    ...
                                    title: 'Heads',
                                    count: cardController.headListCount,
                                    icon: Icons.check_circle,
                                    color: Color(0xFFC12934),
                                    width: width,
                                    height: height,
                                    subtitle: 'Total Heads',
                                  ),
                        ...
                        AssignNewTaskCard(
                          ...
                          function: () => Get.to(
                              () => AssignTicketView(controller: controller)),
                        ),
                        Column(
                          crossAxisAlignment: CrossAxisAlignment.start,
                          children: [
              ...
              Row(
                ...
                children: [
                  ...
                  Container(
                    ...
                    decoration: BoxDecoration(
                      color: Colors.orange
                          .withOpacity(0.77), // yahin color change karo
