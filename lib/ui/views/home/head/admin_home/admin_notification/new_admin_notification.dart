...
class NewAdminNotification extends StatelessWidget {
  const NewAdminNotification({super.key});
                                ...
                                return GestureDetector(
                                  onTap: () {
                                    ...
                                    Get.to(() => NotificationDetail(
                                          title: asyncSnapshot.data!.docs[index]
                                              ['subject'],
                                          description: asyncSnapshot
                                              .data!.docs[index]['description'],
                                          date:
                                              '${dateTime.hour}:${dateTime.minute}:${dateTime.second}',
                                          file: asyncSnapshot.data?.docs[index]
                                                  ['file'] ??
                                              null,
                                          docId: asyncSnapshot
                                              .data!.docs[index].id,
