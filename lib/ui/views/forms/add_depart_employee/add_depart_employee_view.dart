...
class AddDepartEmployeeView extends StatelessWidget {
  const AddDepartEmployeeView({super.key});
        ...
        child: Stack(
          children: [
            ...
            Container(
              ...
              child: GetBuilder<AddDeptEmployeeController>(
                init: Get.put(AddDeptEmployeeController()),
                builder: (controller) {
