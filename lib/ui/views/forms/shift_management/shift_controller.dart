...
class ShiftController extends GetxController {
  ...
  void onInit() {
    ...
    try {
      ...
      print('Timezone database already initialized or error: $e');
    }
    _listenToAllShifts();
  ...
  Future<bool> createShift({
    ...
    try {
      ...
      if (!AvailabilityHelper.isValidTimeFormat(startTime) ||
        ...
        throw Exception('Invalid time format. Use HH:mm (e.g., 09:30)');
      }

      // Validate timezone with fallback
      String validTimezone = timezone;
      try {
        tz.getLocation(timezone);
      } catch (e) {
        print('⚠ Timezone "$timezone" not found, using UTC as fallback');
        validTimezone = 'UTC';
      }
      ...
      print('✓ Shift saved to Firebase with ID: $shiftId');
      ...
      print('❌ Shift creation error: $errorMessage');
      return false;
    }
  }
